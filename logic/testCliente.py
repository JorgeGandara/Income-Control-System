...
class TestCliente(unittest.TestCase):
    person = cliente(id="0", nombre='Nombre',apellido = "Apellido", direccion="Direccion", telefono="Telefono", email="Email", tiempoPermanencia = 0, evennto = "Evento", lugaresPermitido = "Lugares permitidos")
    ...
    def test_lugarPermitido(self):
        self.assertEqual(self.person.evento, 'Evento')

    def test_lugarPermitido(self):
        self.assertEqual(self.person.lugaresPermitidos, 'Lugares permiitidos')
